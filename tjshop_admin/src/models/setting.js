...
export default {
    ...
    effects: {
        * info({ payload, callback }, { call, put }) {
            ...
            yield put({
                type: "_info",
                payload: { result: { info: response.data } }
            });
        ...
        * optionInfo({ payload, callback }, { call, put }) {
            const response = yield call(setting.optionInfo, payload);
            
            if (callback) callback(response);
        },
        * optionEdit({ payload, callback }, { call, put }) {
            const response = yield call(setting.optionEdit, payload);
