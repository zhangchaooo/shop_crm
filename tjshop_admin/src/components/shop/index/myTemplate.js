...
@connect(({ page, loading }) => ({
    pageList: page.list?page.list.data:{},
            ...
            <View>
                ...
                <Table
                    ...
                    pagination={{
                        ...
                        current: pageList.current_page,
                        pageSize: 10,
                        total: pageList.total
                    }}
                    onChange={({ current, pageSize }) => {
                        // router.push(Query.page(current, pageSize));
                        this.initList(current,10);
                    }}
                />
            </View>
        );
            ...
            <View>
                    ...
                    record.is_portal ? <View className={styles.portalView}>
                        ...
                        <InputGroup compact>
                            <Input
                                disabled
                                style={{ width: 276 }}
                                value="http://www.tjshop.cn/wap"
                            />
                            <CopyToClipboard
                                text="http://www.tjshop.cn/wap"
                ...
                <InputGroup compact>
                    <Input
                        disabled
                        style={{ width: 276 }}
                        value="http://www.tjshop.cn/page/1002dassd"
                    />
                    <CopyToClipboard
                        text="http://www.tjshop.cn/page/1002dassd"
                        onCopy={() => message.success("复制成功！", 1)}
                    >
                        <Button>复制</Button>
                    </CopyToClipboard>
