...
import findRoute, {
  getUrlQuery,
} from 'D:/Myzone/tj02/tjshop_admin/node_modules/_umi-build-dev@1.13.11@umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    // Umi UI Bubble
    require('../../../node_modules/_umi-plugin-ui@1.2.11@umi-plugin-ui/lib/bubble').default(
      {
        port: 3003,
        path: 'D:/Myzone/tj02/tjshop_admin',
        currentProject: '',
        isBigfish: undefined,
      },
    );
...
(() => {
  ...
  window.GUmiUIFlag = require('../../../node_modules/_umi-build-dev@1.13.11@umi-build-dev/lib/plugins/commands/block/sdk/flagBabelPlugin/GUmiUIFlag.js').default;
